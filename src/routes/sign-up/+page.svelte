...
<section class="auth__section">
    <article class="auth__article">
        <h1 class="title auth__title">Your Journey Begins&hellip;</h1>
        <div class="auth__form">
            ...
            <form method="POST">
                <div class="form__info">
                    <p>The <em>DemigodS</em> are waiting</p>
                </div>
                ...
                <div class="form__actions">
                    <Button type='submit' priority="em">Sign Up</Button>
                </div>
            </form>
        </div>
    </article>
...
.auth__article {
    ...
    border-radius: 3px;
    background: white;
    box-shadow: 0 0 20px rgba(var(--color-yellow-rgb), 0.3);
}
.auth__title {
    margin: 0;
    padding: 20px 30px;
